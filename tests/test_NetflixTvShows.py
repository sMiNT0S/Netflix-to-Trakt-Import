...
def test_addSingleTvShow():
    ...
    assert ret is not False  # nosec B101
    assert netflixHistory.hasTvShow("Peaky Blinders – Gangs of Birmingham")  # nosec B101
    assert netflixHistory.shows[0].name == "Peaky Blinders – Gangs of Birmingham"  # nosec B101
    assert int(netflixHistory.shows[0].seasons[0].number) == 1  # nosec B101
    assert netflixHistory.shows[0].seasons[0].name is None  # nosec B101
    assert (
...
def test_addMultipleTvShows():
    ...
    assert ret1 is ret2 is ret3 is True  # nosec B101
    assert netflixHistory.hasTvShow("Peaky Blinders – Gangs of Birmingham") is True  # nosec B101
    assert netflixHistory.hasTvShow("Haus des Geldes")  # nosec B101
    assert (
...
def test_addMovie():
    ...
    assert netflixHistory.getMovie("Spider-Man: Far from Home") is not None  # nosec B101
    assert netflixHistory.movies[0].watchedAt[0] == "2021-09-16T20:15:00.00Z"  # nosec B101
